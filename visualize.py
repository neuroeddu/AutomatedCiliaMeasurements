...
def cilia_to_line():  # big func that calls everything else
    ...
    for num in range(1, num_im+1):
        centriole_list, cell_list, associate_list = make_lists_c2c(
            num, grouped_centriole, grouped_cell, grouped_associates
        )
        ...
        if centriole:
            ...
            centriole_list, cilia_list, associate_list = make_lists_c2c(
                num, grouped_centriole, grouped_cilia, grouped_associates, True
            )
...
def make_paths(num, label, centriole_id=False):
