...
df = pd.read_csv('/Users/sneha/Desktop/mni/cilia_true.csv', skipinitialspace=True, usecols=['ImageNum', 'XCoord', 'YCoord']
    )
...
for num in range(1, 8):
    ...
    im='/Users/sneha/Desktop/cilia_TEST/im_output/CiliaOverlay' + f"{num:04}" +  ".tiff"
    img = Image.open(im)
